...
// TODO: I can't seem to start the application. Help! // created main inside of gradesapplication.java and created GradesApplication Object then  runned with init();
// TODO: Even when it was running, it never let me enter in more than one student before exiting. // changed boolean willContinue to input.yesNo() for user response
// TODO: The grade average is WAY too precise. It only needs to display to two decimal places. // used .2f into printf for double and round 2 decimal places
// TODO: Why do I keep seeing information for Fred when I search for Cathy's info? // changed s2 inside of .put for hasmap for cathy which is her variable is s2
